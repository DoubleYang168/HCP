...
<!--              </a-button>-->
      ...
      <a-layout style="padding-left:20px">
        ...
        >
          ...
          <forecast-map v-show="modelStatus === 'stopped' || modelStatus === 'cancelled'"></forecast-map>
        </a-layout-content>
      </a-layout>
    </a-layout>
  </div>
...
<script>
  import {getForecastModelConfig, getForecastModelStatus, runForecastModelConfig, cancelForecastModelConfig, updateForecastModelConfig} from '@/api/forecast'
