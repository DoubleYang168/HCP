          ...
          <div v-show="this.showType === 'list'">
            ...
            >
              <span slot="action" slot-scope="text, record">
                <a @click="downloadFile(record.name, record.name, false)"
                  >下载</a
                >
              </span>
...
export default {
  ...
  methods: {
    ...
    handleClick(item) {
      ...
      if (
        this.contentType === "hhly" ||
        this.contentType === "hjly" ||
        this.contentType === "zyhly" ||
        this.contentType === "whly"
      ) {
